...
| -------------------- | ------------------------------------- | ---------------- | ----------------- | ------------------------------------------ |
| `0.2.0` (unreleased) | customer (`openapi/customer.yaml`)    | 1.1.0            | `v1.1.0`          | `c9a0175d0053f1a2d57c9329f6d3a36ec6acdb71` |
...
snapshot is pinned to immutable tag `v1.1.0` and has no `Idempotency-Key`
